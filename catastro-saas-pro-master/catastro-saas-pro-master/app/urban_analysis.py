...
class AnalizadorUrbanistico:
    ...
    def generar_informe_pdf(self, datos_parcela, afecciones, referencia):
        ...
        # Título
        elements.append(Paragraph(f"INFORME TÉCNICO DE AFECCIONES", styles['Title']))
        ...
        data = [
            ...
            ["Localización", datos_parcela.get('nm', 'Consultar Sede')],
            ["Superficie Catastral", f"{datos_parcela.get('area', 'N/A')} m²"]
        ]
        ...
        # Sección de Afecciones (Usando tus Leyendas CSV)
        elements.append(Paragraph("ANÁLISIS DE AFECCIONES AMBIENTALES", styles['Heading3']))
        ...
        if not afecciones:
            ...
            for af in afecciones:
                ...
                # Crear una pequeña tabla para cada afección con su color
